...
# Set standby delay to half hour (default is 1 hour)
...
# Disable Resume system-wide // TODO: Test
...
# TODO: TEST: defaults write com.apple.screensaver askForPassword -int 1
# TODO: TEST: defaults write com.apple.screensaver askForPasswordDelay -int 0
...
# TODO: TEST: sudo nvram boot-args="mbasd=1"
...
# TODO: defaults write com.apple.dock expose-animation-duration -float 0.1
