...
# ! Warning: Doesn't work since BigSur
...
# Display dialogs instantly (like save)
...
# Example: defaults write com.apple.screencapture location -string "${HOME}/Pictures/Screenshots"
